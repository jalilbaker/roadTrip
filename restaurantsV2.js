$(document).ready(function() {
  ...
  function epSummary() {
    ...
    $.each($("input[name='ep-res-sel-1']:checked"), function() {
      epSumm = epSumm + endPlacesArray[0][0] + ", ";
      endSeleArray.push([endPlacesArray[0][0], endPlacesArray[0][1]]);
      console.log("end selc array ", endSeleArray);
    });

    $.each($("input[name='ep-res-sel-2']:checked"), function() {
      epSumm = epSumm + endPlacesArray[1][0] + ", ";
      endSeleArray.push([endPlacesArray[1][0], endPlacesArray[1][1]]);
    });

    $.each($("input[name='ep-res-sel-3']:checked"), function() {
      epSumm = epSumm + endPlacesArray[2][0] + ", ";
      endSeleArray.push([endPlacesArray[2][0], endPlacesArray[2][1]]);
    });

    $.each($("input[name='ep-res-sel-4']:checked"), function() {
      epSumm = epSumm + endPlacesArray[3][0] + ", ";
      endSeleArray.push([endPlacesArray[3][0], endPlacesArray[3][1]]);
    });
  ...
  function wpSummary() {
    ...
    $.each($("input[name='wp-res-sel-1']:checked"), function() {
      wpSumm = wpSumm + wayPlacesArray[0][0] + ", ";
      waySeleArray.push([wayPlacesArray[0][0], wayPlacesArray[0][1]]);
    });

    $.each($("input[name='wp-res-sel-2']:checked"), function() {
      wpSumm = wpSumm + wayPlacesArray[1][0] + ", ";
      waySeleArray.push([wayPlacesArray[1][0], wayPlacesArray[1][1]]);
    });

    $.each($("input[name='wp-res-sel-3']:checked"), function() {
      wpSumm = wpSumm + wayPlacesArray[2][0] + ", ";
      waySeleArray.push([wayPlacesArray[2][0], wayPlacesArray[2][1]]);
    });

    $.each($("input[name='wp-res-sel-4']:checked"), function() {
      wpSumm = wpSumm + wayPlacesArray[3][0] + ", ";
      waySeleArray.push([wayPlacesArray[3][0], wayPlacesArray[3][1]]);
    });
  ...
  $(document).on("click", ".next-btn", function() {
    ...
    selections.food.endSelection = waySeleArray;
    selections.food.endSelection = endSeleArray;
    // Upload the Road Trip food selectios data object into the database
    data.update(selections);
                
    var RoadTripBudgetData1 = {};           
